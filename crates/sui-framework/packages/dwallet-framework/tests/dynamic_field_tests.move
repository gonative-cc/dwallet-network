...
#[test_only]
module dwallet::dynamic_field_tests {
    ...
    fun simple_all_functions() {
        ...
        // add fields
        add<vector<u8>, u64>(&mut id, b"abc", 0);
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::dynamic_field::EFieldAlreadyExists)]
    fun add_duplicate() {
        let sender = @0x0;
        let scenario = ts::begin(sender);
        let id = ts::new_object(&mut scenario);
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::dynamic_field::EFieldDoesNotExist)]
    fun borrow_missing() {
        let sender = @0x0;
        let scenario = ts::begin(sender);
        let id = ts::new_object(&mut scenario);
    ...
    #[test]
    #[expected_failure(abort_code = dwallet::dynamic_field::EFieldTypeMismatch)]
