...
use signature_mpc::twopc_mpc_protocols::{
    ...
    ProtocolContext, SecretKeyShareEncryptionAndProof,
};
...
use sui_types::signature_mpc::{
    ...
    CREATE_PRESIGN_SESSION_FUNC_NAME, CREATE_SIGN_MESSAGES_FUNC_NAME,
    DKG_SESSION_OUTPUT_STRUCT_NAME, DKG_SESSION_STRUCT_NAME, DWALLET_2PC_MPC_ECDSA_K1_MODULE_NAME,
    DWALLET_MODULE_NAME, DWALLET_STRUCT_NAME, PRESIGN_SESSION_STRUCT_NAME, SIGN_MESSAGES_FUNC_NAME,
        ...
        let ret = Ok(match self {
            SuiDWalletCommands::Create {
                ...
                let tx_data = construct_move_call_transaction(
                    ...
                    &CREATE_DKG_SESSION_FUNC_NAME.as_str(),
                    Vec::new(),
                    gas,
                    gas_budget,
                    Vec::from([commitment]),
            ...
            SuiDWalletCommands::Sign {
                ...
                let centralized_party_sign_round_parties =
                    initiate_centralized_party_sign(dkg_output, centralized_party_presigns)
                        .unwrap();

                let (
                    public_nonce_encrypted_partial_signature_and_proofs,
                    signature_verification_round_parties,
                ): (Vec<_>, Vec<_>) = messages_vec
                    .into_iter()
