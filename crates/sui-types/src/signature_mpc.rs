...
impl DWallet {
    ...
    pub fn is_type(other: &StructTag) -> bool {
        other.address == SUI_SYSTEM_ADDRESS
            ...
            && other.name.as_ident_str() == DWALLET_STRUCT_NAME
    }
...
impl DKGSession {
    ...
    pub fn is_type(other: &StructTag) -> bool {
        other.address == SUI_SYSTEM_ADDRESS
            && other.module.as_ident_str() == DWALLET_2PC_MPC_ECDSA_K1_MODULE_NAME
            && other.name.as_ident_str() == DKG_SESSION_STRUCT_NAME
    }
...
impl PresignSession {
    ...
    pub fn is_type(other: &StructTag) -> bool {
        other.address == SUI_SYSTEM_ADDRESS
            && other.module.as_ident_str() == DWALLET_2PC_MPC_ECDSA_K1_MODULE_NAME
            && other.name.as_ident_str() == PRESIGN_SESSION_STRUCT_NAME
    }
...
impl Presign {
    ...
    pub fn is_type(other: &StructTag) -> bool {
        other.address == SUI_SYSTEM_ADDRESS
            && other.module.as_ident_str() == DWALLET_2PC_MPC_ECDSA_K1_MODULE_NAME
            && other.name.as_ident_str() == PRESIGN_STRUCT_NAME
    }
